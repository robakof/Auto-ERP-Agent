# ERP Agent — Instrukcje operacyjne
...
Składnia SQL dla tego ERP: `documents/ERP_SQL_SYNTAX.md` — przeczytaj przed generowaniem.
...
Per `documents/ERP_SQL_SYNTAX.md`:
...
## Referencja składni SQL

Szczegółowa składnia kolumn, filtrów i parametrów `@PAR` (typy S/D/R),
konwersja dat Clarion → `documents/ERP_SQL_SYNTAX.md`
