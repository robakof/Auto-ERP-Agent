...
SELECT TOP 100000
    ...
    CASE WHEN zwrot.TrN_GIDNumer IS NULL THEN NULL ELSE
        CASE WHEN zwrot.TrN_GenDokMag=-1 AND zwrot.TrN_GIDTyp IN (1521,1529,1489) THEN '(A)'
             WHEN zwrot.TrN_GenDokMag=-1 THEN '(s)' ELSE '' END
        + CASE zwrot.TrN_GIDTyp
            ...
            WHEN 1232 THEN 'KDZ'  ELSE CAST(zwrot.TrN_GIDTyp AS VARCHAR(10)) END
        ...
        + CASE WHEN RTRIM(zwrot.TrN_TrNSeria)='' THEN '' ELSE '/'+RTRIM(zwrot.TrN_TrNSeria) END
    ...
    CASE WHEN zam.ZaN_GIDNumer IS NULL THEN NULL ELSE
        ...
        +CASE WHEN RTRIM(zam.ZaN_ZamSeria)='' THEN '' ELSE '/'+RTRIM(zam.ZaN_ZamSeria) END
    END AS Numer_Zamowienia,
    CASE n.TrN_Stan
        WHEN 0 THEN 'Edycja po dodaniu' WHEN 1 THEN 'Bufor'
        WHEN 2 THEN 'Po edycji w buforze' WHEN 3 THEN 'Zatwierdzona / nierozliczona'
    ...
    CASE
        WHEN n.TrN_GIDTyp IN (2041,2045,1529) AND EXISTS (
            SELECT 1 FROM CDN.TraNag s WHERE s.TrN_SpiTyp=n.TrN_GIDTyp AND s.TrN_SpiNumer=n.TrN_GIDNumer
            AND ((n.TrN_GIDTyp=2041 AND s.TrN_GIDTyp=2009) OR (n.TrN_GIDTyp=2045 AND s.TrN_GIDTyp=2013)
                 OR (n.TrN_GIDTyp=1529 AND s.TrN_GIDTyp=1497))) THEN '(Z)'
        ...
        WHEN n.TrN_GenDokMag=-1 THEN '(s)' ELSE ''
    END
    + CASE n.TrN_GIDTyp
        WHEN 2034 THEN 'PA' WHEN 2033 THEN 'FS' WHEN 1617 THEN 'PW' WHEN 2001 THEN 'WZ'
        WHEN 1521 THEN 'FZ' WHEN 2009 THEN 'WZK' WHEN 1603 THEN 'MMW' WHEN 1604 THEN 'MMP'
        WHEN 1616 THEN 'RW' WHEN 2041 THEN 'FSK' WHEN 2003 THEN 'KK' WHEN 1489 THEN 'PZ'
        WHEN 1497 THEN 'PZK' WHEN 1625 THEN 'PWK' WHEN 1529 THEN 'FZK' WHEN 2042 THEN 'PAK'
        WHEN 2037 THEN 'FSE' WHEN 2013 THEN 'WKE' WHEN 2005 THEN 'WZE' WHEN 1624 THEN 'RWK'
        WHEN 2039 THEN 'RS' WHEN 2045 THEN 'FKE' WHEN 2035 THEN 'RA' WHEN 2004 THEN 'DP'
        WHEN 1232 THEN 'KDZ' ELSE CAST(n.TrN_GIDTyp AS VARCHAR(10))
      END
    +'-'+CAST(n.TrN_TrNNumer AS VARCHAR(10))
    +'/'+RIGHT('0'+CAST(n.TrN_TrNMiesiac AS VARCHAR(2)),2)
    +'/'+RIGHT(CAST(n.TrN_TrNRok AS VARCHAR(4)),2)
    +CASE WHEN RTRIM(n.TrN_TrNSeria)='' THEN '' ELSE '/'+RTRIM(n.TrN_TrNSeria) END AS Numer_Dokumentu,
    CASE WHEN n.TrN_Data2 BETWEEN 1 AND 109211 THEN CAST(DATEADD(d,n.TrN_Data2-36163,'1899-12-28') AS DATE) ELSE NULL END AS Data_Wystawienia,
    CASE WHEN n.TrN_Data3 BETWEEN 1 AND 109211 THEN CAST(DATEADD(d,n.TrN_Data3-36163,'1899-12-28') AS DATE) ELSE NULL END AS Data_Sprzedazy,
    CASE WHEN n.TrN_Termin BETWEEN 1 AND 109211 THEN CAST(DATEADD(d,n.TrN_Termin-36163,'1899-12-28') AS DATE) ELSE NULL END AS Termin_Platnosci,
    CASE WHEN n.TrN_DataMag BETWEEN 1 AND 109211 THEN CAST(DATEADD(d,n.TrN_DataMag-36163,'1899-12-28') AS DATE) ELSE NULL END AS Data_Magazynowa,
    CASE WHEN n.TrN_DataRoz BETWEEN 1 AND 109211 THEN CAST(DATEADD(d,n.TrN_DataRoz-36163,'1899-12-28') AS DATE) ELSE NULL END AS Data_Rozliczenia,
    CASE WHEN n.TrN_DataPO BETWEEN 1 AND 109211 THEN CAST(DATEADD(d,n.TrN_DataPO-36163,'1899-12-28') AS DATE) ELSE NULL END AS Data_Obowiazku_Pod,
    CASE WHEN n.TrN_DataWplywu BETWEEN 1 AND 109211 THEN CAST(DATEADD(d,n.TrN_DataWplywu-36163,'1899-12-28') AS DATE) ELSE NULL END AS Data_Wplywu,
    CASE WHEN n.TrN_DataWysylki BETWEEN 1 AND 109211 THEN CAST(DATEADD(d,n.TrN_DataWysylki-36163,'1899-12-28') AS DATE) ELSE NULL END AS Data_Wysylki,
    CASE WHEN n.TrN_DataWystOrg=0 THEN NULL ELSE CAST(DATEADD(d,n.TrN_DataWystOrg-36163,'1899-12-28') AS DATE) END AS Data_Wyst_Oryginalu,
    CASE WHEN n.TrN_DataSprOrg=0 THEN NULL ELSE CAST(DATEADD(d,n.TrN_DataSprOrg-36163,'1899-12-28') AS DATE) END AS Data_Spr_Oryginalu,
    CASE WHEN n.TrN_DataOdKor=0 THEN NULL ELSE CAST(DATEADD(d,n.TrN_DataOdKor-36163,'1899-12-28') AS DATE) END AS Data_Zakresu_Kor_Od,
    CASE WHEN n.TrN_DataDoKor=0 THEN NULL ELSE CAST(DATEADD(d,n.TrN_DataDoKor-36163,'1899-12-28') AS DATE) END AS Data_Zakresu_Kor_Do,
    ...
    CASE WHEN n.TrN_FormaNr=10 THEN 'Gotowka' WHEN n.TrN_FormaNr=20 THEN 'Przelew'
         ...
         ELSE 'Uzytkownika ('+CAST(n.TrN_FormaNr AS VARCHAR(5))+')' END AS Forma_Platnosci,
    ...
    CASE n.TrN_VatTyp WHEN 1 THEN 'Zakup' WHEN 2 THEN 'Sprzedaz' WHEN 0 THEN NULL
         ELSE 'Nieznane ('+CAST(n.TrN_VatTyp AS VARCHAR(5))+')' END AS Rejestr_VAT,
    CASE n.TrN_FlagaNB WHEN 'N' THEN 'Od netto' WHEN 'B' THEN 'Od brutto' ELSE n.TrN_FlagaNB END AS VAT_Od,
    CASE n.TrN_Platnosci WHEN 1 THEN 'Tak' WHEN 0 THEN 'Nie'
         ELSE 'Nieznane ('+CAST(n.TrN_Platnosci AS VARCHAR(3))+')' END AS Jest_Platnosc,
...
FROM CDN.TraNag n
LEFT JOIN CDN.TraNag zwrot ON zwrot.TrN_GIDNumer=n.TrN_ZwrNumer AND n.TrN_ZwrNumer>0
LEFT JOIN CDN.KntKarty knt ON knt.Knt_GIDNumer=n.TrN_KntNumer AND knt.Knt_GIDTyp=n.TrN_KntTyp AND n.TrN_KntNumer>0
LEFT JOIN CDN.KntKarty knd ON knd.Knt_GIDNumer=n.TrN_KnDNumer AND knd.Knt_GIDTyp=n.TrN_KnDTyp AND n.TrN_KnDNumer>0
LEFT JOIN CDN.KntAdresy kna_k ON kna_k.KnA_GIDNumer=n.TrN_KnANumer AND n.TrN_KnANumer>0
LEFT JOIN CDN.KntAdresy kna_w ON kna_w.KnA_GIDNumer=n.TrN_AdWNumer AND n.TrN_AdWNumer>0
LEFT JOIN CDN.KntKarty akw_knt ON akw_knt.Knt_GIDNumer=n.TrN_AkwNumer AND n.TrN_AkwTyp=32 AND n.TrN_AkwNumer>0
LEFT JOIN CDN.PrcKarty akw_prc ON akw_prc.Prc_GIDNumer=n.TrN_AkwNumer AND n.TrN_AkwTyp=944 AND n.TrN_AkwNumer>0
LEFT JOIN CDN.ZamNag zam ON zam.ZaN_GIDNumer=n.TrN_ZaNNumer AND n.TrN_ZaNNumer>0
LEFT JOIN CDN.Magazyny mag_z ON mag_z.MAG_GIDNumer=n.TrN_MagZNumer AND n.TrN_MagZNumer>0
LEFT JOIN CDN.Magazyny mag_d ON mag_d.MAG_GIDNumer=n.TrN_MagDNumer AND n.TrN_MagDNumer>0
LEFT JOIN CDN.OpeKarty ope_w ON ope_w.Ope_GIDNumer=n.TrN_OpeNumerW AND n.TrN_OpeNumerW>0
LEFT JOIN CDN.OpeKarty ope_z ON ope_z.Ope_GIDNumer=n.TrN_OpeNumerZ AND n.TrN_OpeNumerZ>0
LEFT JOIN CDN.OpeKarty ope_r ON ope_r.Ope_GIDNumer=n.TrN_OpeNumerR AND n.TrN_OpeNumerR>0
