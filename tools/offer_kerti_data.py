...
def _read_excel(excel_path: str) -> dict[str, bool]:
    """Zwraca {kod: nowosc} z Excela."""
...
def _query_grupy(gid_list: str) -> dict:
    from sql_query import run_query
    sql = f"""
        SELECT br.TwG_GIDNumer, MIN(RTRIM(grp.TwG_Nazwa))
