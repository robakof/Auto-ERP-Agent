...
Layout: A4 pionowy, siatka 3×2 kart (zaokrąglone rogi, cień, dużo whitespace).
Zawartość karty: zdjęcie → nazwa (uppercase) → 3 parametry → cena (orange, duża).
...
COLS        = 3
ROWS        = 2
GAP         = 6 * mm       # odstęp między kartami
