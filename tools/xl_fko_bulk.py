"""Import wsadowy faktur kosztowych FKo z katalogu XML do Comarch XL.

Skanuje katalog, parsuje pliki KSeF FA(3), importuje przez XL API.
Jeden błędny plik nie zatrzymuje pozostałych.

Użycie:
  python tools/xl_fko_bulk.py --dir katalog/z/xml
  python tools/xl_fko_bulk.py --dir katalog/z/xml --report raport.xlsx
"""
...
from tools.xl_fko_set import set_invoice
...
def main() -> None:
    ...
    default_report = Path(f"documents/human/reports/xl_fko_bulk_{ts}.xlsx")

    parser = argparse.ArgumentParser(description="Wsadowy import FKo z katalogu XML do Comarch XL")
