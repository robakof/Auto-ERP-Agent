...
// Wersja: 2023.1 (cdn_api20231.net.dll)
// Komendy: login | logout | invoke | blad
// Format: {"cmd":"...","key":"val",...}\n
// invoke: {"cmd":"invoke","method":"XLNowyDokument","sesja_id":1,"params":{"Wersja":20231,...}}
...
class XlProxy {
    ...
    static void Main(string[] args) {
        dllDir = args.Length > 0 ? args[0] : @"C:\Program Files (x86)\Comarch ERP XL 2023.1";
        string dllPath = Path.Combine(dllDir, "cdn_api20231.net.dll");
    ...
    static string CmdInvoke(string json) {
        ...
        for (int i = 0; i < pinfos.Length; i++) {
            ...
            if (pt == typeof(int)) {
                ...
                if (fVer != null) fVer.SetValue(info, 20231);
    ...
    static string CmdLogin(string json) {
        object info = CreateInfo("cdn_api.XLLoginInfo_20231");
        SetField(info, "Wersja",     20231);
    ...
    static string CmdBlad() {
        object info = CreateInfo("cdn_api.XLKomunikatInfo_20231");
        SetField(info, "Wersja", 20231);
