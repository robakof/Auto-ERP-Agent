"""GUI do importu faktur kosztowych FKo z KSeF XML do Comarch XL.

Użycie:
  python tools/xl_fko_app.py
"""
...
from tkinter import (
    Button, Frame, Label, StringVar, Tk, Toplevel,
    Entry, filedialog, messagebox,
)
...
from tools.xl_fko_bulk import bulk_import
...
def _report_path() -> Path:
    ...
    return _REPORTS_DIR / f"xl_fko_bulk_{ts}.xlsx"
...
class LoginDialog(Toplevel):
    """Modal dialog logowania XL API."""

    def __init__(self, parent: Tk):
        super().__init__(parent)
        self.title("Logowanie — Import FKo CEiM")
    ...
    def _on_ok(self):
        ...
        if not all([login, password]):
            messagebox.showwarning("Brak danych", "Login i hasło są wymagane.", parent=self)
            return
