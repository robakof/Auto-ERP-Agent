...
def build_bom_rows(
    ...
    wklad_akronim: kod wkladu z waga skladak.xlsx (wg gramatura AtkId=10) lub None
    ...
    return [
        BomRow("Surowiec", "Dekiel",                   dekiel_akronim, 1),
        ...
        BomRow("Surowiec", "Wkład",                    wklad_akronim, 1),
